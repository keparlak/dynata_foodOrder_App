...
function AdminPage() {
  ...
  return (
    <div className="flex">
      <aside className="flex flex-col w-64 h-screen px-5 py-2 overflow-y-auto bg-white border-r rtl:border-r-0 rtl:border-l dark:bg-gray-900 dark:border-gray-700">
